...
rich_content = r'''function RichContent({product}:{product:Product}){
  ...
  const story=night?{
    ...
    hero:"/assets/images/time-hero.png",
    portrait:"/assets/images/night-editorial.png",
    detail:"/assets/images/blue-bedroom.png",
    still:"/assets/images/moon-plate.png",
    ...
    hero:"/assets/images/russian-bedroom.png",
    portrait:"/assets/images/poetry-editorial.png",
    detail:"/assets/images/beige-bedroom.png",
    still:"/assets/images/classic-bedroom.png",
