...
.plp-compact-add{width:100%;min-height:42px!important;height:42px!important;margin:2px 0 0!important;padding:0 12px!important;border:0!important;font-size:9px!important;letter-spacing:.04em!important;transition:background-color .16s ease,color .16s ease!important}
...
print("Applied compact PLP quick-add modal with strict CTA states")
