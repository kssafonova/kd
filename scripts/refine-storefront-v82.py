...
old_card='<RemoteImage src={rowImages(row)[0]||"/assets/images/image-placeholder.svg"} fallbackSrc="/assets/images/image-placeholder.svg" alt={name}/>'
new_card='<RemoteImage src={rowImages(row)[0]||solution.heroImage||baseRows[0]?.primary_image_url||"/assets/images/caps_led.png"} fallbackSrc={solution.heroImage||baseRows[0]?.primary_image_url||"/assets/images/caps_led.png"} alt={name}/>'
ready=ready.replace(old_card,new_card)
ready_path.write_text(ready,encoding='utf-8')

page=page_path.read_text(encoding='utf-8')
page=page.replace('image:"/assets/images/constructor/warm-brutalism.jpeg"','image:"/assets/images/bluegold2.jpeg"')
